...
This article demonstrates how to create .docx Word document with merge fields. This document can be used document generation actions. For example, in the `Fill Merge Fields in DOCX <../../flow/actions/document-processing.html#fill-merge-fields-in-docx>`_ action.
